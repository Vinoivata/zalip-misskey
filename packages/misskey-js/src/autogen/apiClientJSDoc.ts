...
declare module '../api.js' {
  export interface APIClient {
    ...
    /**
     * Explicitly refreshes the bounded Alloha cache and processes title subscriptions.
     *
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'zalip/admin/alloha/sync', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:notes*
     */
    request<E extends 'zalip/admin/discussions/create', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'zalip/admin/seasons/import-tmdb', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'zalip/admin/works/create', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'zalip/admin/works/import-tmdb', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *read:account*
     */
    request<E extends 'zalip/admin/works/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
    ...
    /**
     * Explicitly refreshes provider-owned facts and artwork for at most 100 TMDB-backed Zalip works.
     *
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'zalip/admin/works/sync-all-tmdb-media', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'zalip/admin/works/sync-tmdb-media', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'zalip/admin/works/update', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'zalip/admin/works/update-state', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
    ...
    /**
     * Create the hidden local root for a published Zalip title discussion when it does not exist yet.
     *
     * **Credential required**: *Yes* / **Permission**: *write:notes*
     */
    request<E extends 'zalip/discussions/ensure', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No*
     */
    request<E extends 'zalip/discussions/show', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
    ...
    /**
     * Create the hidden local root for a published Zalip episode discussion when it does not exist yet.
     *
     * **Credential required**: *Yes* / **Permission**: *write:notes*
     */
    request<E extends 'zalip/episodes/discussions/ensure', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *read:account*
     */
    request<E extends 'zalip/library/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'zalip/library/update', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
    ...
    /**
     * Returns cached, validated Alloha iframe choices for a published Zalip work after login.
     *
     * **Credential required**: *Yes* / **Permission**: *read:account*
     */
    request<E extends 'zalip/playback/alloha/show', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
    ...
    /**
     * List recent Zalip episode arrivals for published catalogue works.
     *
     * **Credential required**: *No*
     */
    request<E extends 'zalip/releases/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
    ...
    /**
     * List recent episode arrivals only for works the signed-in user follows in Zalip.
     *
     * **Credential required**: *Yes* / **Permission**: *read:account*
     */
    request<E extends 'zalip/releases/subscribed', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
    ...
    /**
     * List canonical episode metadata for one published Zalip season. Playback sources are not included.
     *
     * **Credential required**: *No*
     */
    request<E extends 'zalip/seasons/episodes', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No*
     */
    request<E extends 'zalip/works/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
    ...
    /**
     * Search published Zalip titles by a literal title or original title fragment.
     *
     * **Credential required**: *No*
     */
    request<E extends 'zalip/works/search', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
    ...
    /**
     * Show one published Zalip cinema title by its canonical slug.
     *
     * **Credential required**: *No*
     */
    request<E extends 'zalip/works/show', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
