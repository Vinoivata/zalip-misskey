...
- The title page writes a personal library entry through the signed-in Misskey user: status,
  ...
  same entry. The library route shows those signals and a compact aggregate of reading status,
  favourites and personal ratings without a second profile or account.
